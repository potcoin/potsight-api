...
var encodedData = require('soop').load('potcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('potcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('potcore/lib/Address', {
